<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="WomanSarees.aspx.cs" Inherits="MyEShoppingWebsite.WomanSarees" %>
    ...
    <div class="panel panel-primary">
      ...
      <asp:repeater ID="rptrProducts" runat="server">
        ...
        <div class="col-sm-3 col-md-3">
            <a href="Productiew.aspx?PID=<%# Eval("PID") %>" style="text-decoration:none;">
          <div class="thumbnail">              
