 ...
 <br />
     <div class ="form-horizontal">
         ...
         <div class="form-group">
             <asp:Label ID="Label" CssClass ="col-md-2 control-label" runat="server" Text="Brand Name"></asp:Label>
             <div class="col-md-3">
                 <asp:TextBox ID="txtBrand"  CssClass="form-control" runat="server"></asp:TextBox>
                 <asp:RequiredFieldValidator ID="RequiredFieldValidatorBrandName" runat="server" CssClass="form-danger" ErrorMessage="Enter Your Brand Name" ControlToValidate="txtBrand" ForeColor="Red"></asp:RequiredFieldValidator>
